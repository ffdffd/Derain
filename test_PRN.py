...
# parser.add_argument("--data_path", type=str, default="/media/r/BC580A85580A3F20/dataset/rain/peku/Rain100H/rainy/", help='path to training data')   # 3.28 BUG 防止add path时，斜杠不一致
parser.add_argument("--data_path", type=str, default="datasets/train/Rain100H/rainy/", help='path to training data')
# parser.add_argument("--save_path", type=str, default="/home/r/works/derain_arxiv/release/results/PReNet/", help='path to save results')   # 3.28 BUG 防止add path时，斜杠不一致
