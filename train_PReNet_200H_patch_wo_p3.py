...
parser.add_argument("--save_path", type=str, default="/home/huangjiehui/Project/DerainNet/JackCode/Derain/Logs/200H_patch_wop3", help='path to save models and log files')  # 3.28 BUG 防止add path时，斜杠不一致
...
def main():
    ...
    model = AMCC2_wo_p3(recurrent_iter=opt.recurrent_iter, use_GPU=opt.use_gpu).cuda()
