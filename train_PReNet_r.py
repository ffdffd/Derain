...
parser.add_argument("--save_path", type=str, default="logs/PReNet_test/", help='path to save models and log files')  # 3.28 BUG 末尾添加/，防止add path时，斜杠不一致  BUG 将原来的 PReNet/ 改为 PReNet_test/
parser.add_argument("--save_freq",type=int,default=1,help='save intermediate model')
parser.add_argument("--data_path",type=str, default="datasets/train/RainTrainL/",help='path to training data')  # 3.28 BUG 末尾添加/，防止add path时，斜杠不一致
