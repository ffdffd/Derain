...
class AMCC2(nn.Module):
    ...
    def forward(self, input):
        ...
        padding = 1 if input.size(-1) == 96 else 0
        ...
        input3 = torch.cat((input2, pred2), 1) # 将input2和core2进行拼接  得到input3 ([18, 12, 96, 96]) 注意，input堆叠多次后，self.conv0(x) 的输入通道也要相应改变
