...
parser.add_argument("--batch_size", type=int, default=8, help="Training batch size") # batch_size 设置为 18，游戏本顶不住，这里改为2
...
parser.add_argument("--save_path", type=str, default="/home/huangjh/Project/DeRain/JackCode/PreNet_Demo_copy/logs/PReNet_HHF_outdoor_Defogge/New_BLS", help='path to save models and log files')  # 3.28 BUG 防止add path时，斜杠不一致
...
def main():
    ...
    for epoch in range(initial_epoch, opt.epochs):
        ...
        for i, (input_train, target_train) in enumerate(loader_train, 0):
            print(batch_PSNR(input_train,target_train,1.0))
            continue
...
if __name__ == "__main__":
    ...
    #         prepare_data_Rain12600(data_path=opt.data_path, patch_size=100, stride=100)
        ...
        #     prepare_data_X2Data_2(data_path=opt.data_path, patch_size=100, stride=100)
    #     else:
