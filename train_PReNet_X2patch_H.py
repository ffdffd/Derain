...
parser.add_argument("--batch_size", type=int, default=4, help="Training batch size") # batch_size 设置为 18，游戏本顶不住，这里改为2
...
parser.add_argument("--save_path", type=str, default="/home/huangjiehui/Project/DerainNet/Logs/X2_H_patch_2", help='path to save models and log files')  # 3.28 BUG 防止add path时，斜杠不一致
...
def main():
    ...
    dataset_train = Dataset_X2patch_H()  # cuole 
