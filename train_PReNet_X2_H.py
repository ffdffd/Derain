...
parser.add_argument("--save_path", type=str, default="/home/huangjiehui/Project/DerainNet/Logs/X2_H", help='path to save models and log files')  # 3.28 BUG 防止add path时，斜杠不一致
...
def main():
    ...
    dataset_train = Dataset_RainX2_H()  # cuole 
