...
parser.add_argument("--batch_size", type=int, default=160, help="Training batch size") # batch_size 设置为 18，游戏本顶不住，这里改为2
...
parser.add_argument("--save_path", type=str, default="/home/huangjiehui/Project/DerainNet/Logs/_800", help='path to save models and log files')  # 3.28 BUG 防止add path时，斜杠不一致
...
def main():
    ...
    dataset_train = Dataset_800('/data1/hjh/62190446236f408cbb1b3bb08c8b1241/JackFiles/ProjectData/RainData/DeRain/Rain800/Rain800')
