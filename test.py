...
SOTS_O_log_path = '/home/huangjiehui/Project/DerainNet/Logs/Train_OTS2'
    ...
    with torch.no_grad(): 
        ...
        for out, gt in tqdm.tqdm(loader_train):
            ...
            if 0: # 输出图像
                ...
                cv2.imwrite(f'/home/huangjiehui/Project/DerainNet/JackCode/Derain/{count}.jpg',cv2.merge([b ,g, r]))
            # except:
            #     pass
            # break
...
if __name__ == "__main__":
    ...
    count+=1
    print(res)
    # res += test(model,X2path,Dataset_DID_800(data_path_800),count)
    count+=1
    print(res)
