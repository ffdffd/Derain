...
parser.add_argument("--batch_size", type=int, default=6, help="Training batch size") # batch_size 设置为 18，游戏本顶不住，这里改为2
...
parser.add_argument("--save_path", type=str, default="/home/huangjiehui/Project/DerainNet/JackCode/Derain/Logs/200H_patch_wop2", help='path to save models and log files')  # 3.28 BUG 防止add path时，斜杠不一致
...
def main():
    ...
    model = AMCC2_wo_p2(recurrent_iter=opt.recurrent_iter, use_GPU=opt.use_gpu).cuda()
    ...
    for epoch in range(initial_epoch, opt.epochs):
        ...
        for i, (input_train, target_train) in enumerate(tqdm(loader_train, ncols=100)):
